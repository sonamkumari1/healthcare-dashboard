...
function Main() {
  return (
    <div className="w-5/5 mx-3 my-5 bg-red-50">
      <div className="appointment-section pt-5 pb-28  mt-2   rounded-lg flex flex-col"  style={{backgroundColor: '#3adbb9'}}>
      ...
      >
        <div>
          <div className="date  font-bold p-2 text-white rounded-md mt-2" style={{backgroundColor: '#3adbb9'}}>
            <span>06</span>
            <div>Saturday</div>
          </div>
          <div className="text-m mt-1"> <strong>10:00 AM</strong></div>
        </div>
      ...
      <div className="appointment-section pt-5 pb-28  mt-10 rounded-lg flex flex-col "  style={{backgroundColor: '#3adbb9'}}>
        <h2 className="mb-5 ml-5 text-3xl text-white font-semibold">
          Pending Bills
        </h2>
      </div>
      ...
      >
        ...
        <div className="bill-amount mt-2 flex flex-col items-end">
          <button className="pay-now py-2 px-4  text-white rounded-full mt-2 text-sm" style={{backgroundColor: '#3adbb9'}}>
            Pay Now
          </button>
        </div>
      </div>

      <div className="services-section flex flex-wrap justify-around mt-10 mb-20">
        <div className="service-card bg-white p-2 rounded-lg shadow-md w-[calc(50%-16px)] my-2 mx-2 text-center text-sm">
          ...
          <img
            ...
            alt=""
            className="rounded-full p-2 mt-8 h-28 w-28 ml-10 "
          />
        </div>
        <div className="service-card bg-white p-2 rounded-lg shadow-md w-[calc(50%-16px)] my-2 mx-2 text-center text-sm">
        ...
        <div className="text-left">
          ...
          <br /> <span className="text-gray-400">Analytics of Your Health</span>
          </div>
          <img
